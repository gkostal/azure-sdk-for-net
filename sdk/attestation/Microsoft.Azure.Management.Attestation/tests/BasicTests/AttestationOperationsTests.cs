    ...
    public class AttestationOperationsTests : TestBase
    {
        ...
        public void AttestationManagementAttestationCreateDelete()
        {
            using (MockContext context = MockContext.Start(this.GetType()))
            {
                ...
                var instanceParams = new AttestationServiceCreationParams { Location = "East US", Properties  = new AttestationServiceCreationSpecificParams { PolicySigningCertificates = jwks} };
                try
                {
